template <typename T>
Array<T>::Array(): _total(0)
{
    this->_array = NULL;
}

template <typename T>
Array<T>::Array(unsigned int n): _total(n)
{
    this->_array = new T[n];
}

template <typename T>
Array<T>::Array(const Array &a): _total(a._total)
{
...
template <typename T>
const char *Array<T>::NullArrayException::what(void) const throw()
{
