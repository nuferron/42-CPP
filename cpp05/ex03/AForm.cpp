...
/*   Updated: 2024/04/22 11:50:00 by nuferron         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "AForm.hpp"

AForm::AForm(): _name("Form"), _signed(0), _reqsign(50) , _reqexe(25) {}
...
AForm::AForm(int reqsign, int reqexe): _name("Form"), _signed(0), _reqsign(reqsign), _reqexe(reqexe)
{
